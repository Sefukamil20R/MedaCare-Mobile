...
class _CompleteProfilePageState extends State<CompleteProfilePage> {
    ...
    return Column(
      children: [
        buildDateField(
          label: 'Date of Birth',
          hint: '2024-04-20',
          onChanged: (value) => profileData['dateOfBirth'] = value,
          validator: (value) {
        ...
        IntlPhoneField(
          ...
          onChanged: (phone) => profileData['contactNumber'] = phone.completeNumber,
          validator: (value) {
            if (value == null ) {
        ...
        IntlPhoneField(
          ...
          initialCountryCode: 'ET',
          onChanged: (phone) => profileData['emergencyContactNumber'] = phone.completeNumber,
          validator: (value) {
            if (value == null ) {
        ...
        buildTextField(
          label: 'City/District',
          hint: 'City Name',
          onChanged: (value) => profileData['city'] = value,
          validator: (value) {
            if (value == null || value.isEmpty) {
        ...
        buildTextField(
          label: 'Subcity',
          hint: 'Subcity Name',
          onChanged: (value) => profileData['subCity'] = value,
          validator: (value) {
            if (value == null || value.isEmpty) {
  ...
  Widget buildDropdownField(String label, List<String> options, String key, String errorMessage) {
    return DropdownButtonFormField<String>(
      ...
      onChanged: (newValue) => profileData[key] = newValue,
      validator: (value) {
        if (value == null || value.isEmpty) {
          return errorMessage;
        }
